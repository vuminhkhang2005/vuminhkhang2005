...
![Profile Banner](https://capsule-render.vercel.app/api?type=waving&height=230&color=0:0F172A,45:2563EB,100:14B8A6&text=Vu%20Minh%20Khang&fontColor=F8FAFC&fontSize=46&fontAlignY=36&desc=Software%20Engineering%20Student%20%7C%20Full-Stack%20Web%20Developer%20%7C%20Backend%20Enthusiast&descAlignY=57&descSize=16&animation=fadeIn)
...
<img src="https://komarev.com/ghpvc/?username=vuminhkhang2005&style=flat-square&color=14B8A6" alt="Profile views" />

<br />
<br />

<strong>I build practical web systems with clean backend logic, database-driven workflows, and usable interfaces.</strong>
...
I am a software engineering student in Vietnam, focused on building practical full-stack applications and backend systems. I like projects with real workflows: authentication, CRUD, role-based access, database design, reporting, and clean project structure.

<table>
  <tr>
    <td width="33%">
      <strong>Backend</strong><br />
      REST APIs, business logic, authentication, controllers, services
    </td>
    <td width="33%">
      <strong>Data</strong><br />
      MySQL, SQL Server, MongoDB, JPA, ADO.NET, stored procedures
    </td>
    <td width="33%">
      <strong>Frontend</strong><br />
      React, Razor views, responsive UI, clean layouts, JavaScript
    </td>
  </tr>
</table>
...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/csharp/csharp-original.svg" alt="C#" width="28" height="28" />
...
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/microsoftsqlserver/microsoftsqlserver-original.svg" alt="SQL Server" width="28" height="28" />
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        ...
        <img src="https://img.shields.io/badge/Spring%20Boot-0F172A?style=flat-square&logo=springboot&logoColor=22C55E" alt="Spring Boot" />
        <img src="https://img.shields.io/badge/Security-0F172A?style=flat-square&logo=springsecurity&logoColor=22C55E" alt="Spring Security" />
        <img src="https://img.shields.io/badge/MySQL-0F172A?style=flat-square&logo=mysql&logoColor=38BDF8" alt="MySQL" />
      </p>
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/csharp/csharp-original.svg" alt="C#" width="18" height="18" />
        ...
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/microsoftsqlserver/microsoftsqlserver-original.svg" alt="SQL Server" width="18" height="18" />
    ...
    <td width="50%" valign="top">
      ...
      <p>
        <img src="https://img.shields.io/badge/ASP.NET%20MVC-0F172A?style=flat-square&logo=dotnet&logoColor=512BD4" alt="ASP.NET MVC" />
        <img src="https://img.shields.io/badge/Razor-0F172A?style=flat-square&logo=razorpay&logoColor=38BDF8" alt="Razor" />
...
```text
Backend APIs        RESTful services, authentication, business workflows
Database Systems    MySQL, SQL Server, MongoDB, JPA, ADO.NET
Full-Stack Apps     React, Express.js, Spring Boot, ASP.NET Core MVC
Work Habits         Documentation, debugging, version control, clean structure
```

## Connect

I am open to internships, collaboration, and projects where I can keep improving through real engineering work.
...
![Footer](https://capsule-render.vercel.app/api?type=waving&height=110&section=footer&color=0:14B8A6,50:2563EB,100:0F172A)
